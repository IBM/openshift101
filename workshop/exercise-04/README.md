...
Hopefully you have your running script simulating load \(if not go [here](exercise-02.md#simulate-load-on-the-application)\), Grafana showed you that your application was consuming anywhere between ".002" to ".02" cores. This translates to 2-20 "millicores".
