...
![architecture](../.gitbook/assets/-Lti9WcAPYU97e8yFB7v-image.png)
...
1. Deploy the application to the cluster and expose the service
...
1. Apply the deployment to OpenShift
